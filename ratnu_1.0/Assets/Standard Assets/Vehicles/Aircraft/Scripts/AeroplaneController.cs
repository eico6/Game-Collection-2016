...
namespace UnityStandardAssets.Vehicles.Aeroplane
{
    ...
    public class AeroplaneController : MonoBehaviour
    {
        ...
        private GameObject ThrustSpawner;
        ...
        private void Start()
        {
            ...
            ThrustSpawner = GameObject.Find("ThrustSpawn");
        ...
        private void Update()
        {
            m_MaxEnginePower = 40f;

            if (Input.GetKey(KeyCode.LeftShift))
            {
                m_MaxEnginePower = 200;
                Instantiate(thrust, new Vector3 (ThrustSpawner.transform.position.x, ThrustSpawner.transform.position.y, ThrustSpawner.transform.position.z), Quaternion.identity);
            }
        }
